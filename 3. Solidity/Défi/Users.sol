...
contract Users is Common {
    ...
    modifier onlyRegisteredInWhitelist() { // Modifier       
        require(
    ...
    /// @dev La fonction doit vérifier que l'utilisateurs est valide et que le statut soit bien en enregistrement de propositions
    function voteForFavoriteProposal(uint proposalId) public onlyRegisteredInWhitelist onlyVotingSessionIsStarted {
        require(
